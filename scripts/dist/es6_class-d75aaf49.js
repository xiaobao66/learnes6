...
/***/ function(module, exports) {
	...
	try {
	    ...
	    for (var _iterator2 = new GeneratorClass('hello', 'xiaobao')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	var StaticMethodClass = function () {
	    function StaticMethodClass() {
	        _classCallCheck(this, StaticMethodClass);
	    }

	    _createClass(StaticMethodClass, null, [{
	        key: 'hello',
	...
	var ChildStaticMethodClass = function (_StaticMethodClass) {
	    _inherits(ChildStaticMethodClass, _StaticMethodClass);

	    function ChildStaticMethodClass() {
	        _classCallCheck(this, ChildStaticMethodClass);

	        return _possibleConstructorReturn(this, (ChildStaticMethodClass.__proto__ || Object.getPrototypeOf(ChildStaticMethodClass)).call(this));
	    }

	    _createClass(ChildStaticMethodClass, null, [{
	        key: 'hello',
	        value: function hello() {
	            return _get(ChildStaticMethodClass.__proto__ || Object.getPrototypeOf(ChildStaticMethodClass), 'hello', this).call(this) + ', too';
	        }
	    }]);

	    return ChildStaticMethodClass;
	}(StaticMethodClass);
	...
	var Square = function (_Rectangle) {
	    ...
	    function Square(length) {
	        ...
	        return _possibleConstructorReturn(this, (Square.__proto__ || Object.getPrototypeOf(Square)).call(this, length, length));
	    }

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = [helloXiaobao, fun, arrFun, objectEntries, objectEntries2, inner, outer, inner2, outer2].map(regeneratorRuntime.mark);
	...
	function helloXiaobao() {
	    return regeneratorRuntime.wrap(function helloXiaobao$(_context) {
	        while (1) {
	...
	function fun() {
	    var i, reset;
	    return regeneratorRuntime.wrap(function fun$(_context2) {
	        while (1) {
	...
	//for...of循环
	function arrFun() {
	    return regeneratorRuntime.wrap(function arrFun$(_context3) {
	        while (1) {
	...
	try {
	    for (var _iterator = arrFun()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var i = _step.value;
	...
	function objectEntries(obj) {
	    var keys, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, key;

	    return regeneratorRuntime.wrap(function objectEntries$(_context4) {
	        while (1) {
	    ...
	    }, _marked[3], this, [[4, 15, 19, 27], [20,, 22, 26]]);
	}
	...
	try {
	    for (var _iterator3 = objectEntries(me)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	function objectEntries2() {
	    ...
	    return regeneratorRuntime.wrap(function objectEntries2$(_context5) {
	        while (1) {
	...
	try {
	    for (var _iterator5 = me2[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	...
	console.log([].concat(_toConsumableArray(outer()))); //[1, 2, 3, 4]
	...
	console.log([].concat(_toConsumableArray(outer2())));
	//inner ends
	//[1, 2, 3, 4]
